    ...
    <div>
      ...
      <h1>Todo List</h1>
        <div className="app-container">
          {/* logo */}
          <div className="logo">
            <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExN2dveGJ6NDBrbTNjb3dqa3Jmc3ZsZThxMnN2OWhreGJiOTBiNnljOSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/4GWmvKBiml8vPQUchI/giphy.gif" 
            alt="Logo" style={{ width: 250 }} />
          </div>
          {/* text box */}
